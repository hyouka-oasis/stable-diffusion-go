...
func Routers() *gin.Engine {
	...
	}
	{
		...
		systemRouter.InitInfoRouter(PublicGroup)          // 项目详情列表接口
		systemRouter.InitTaskRouter(PublicGroup)          // 任务接口
		...
		systemRouter.InitOllamaRouter(PublicGroup)   // ollama接口

		systemRouter.InitStableDiffusionRouter(PublicGroup)         // stableDiffusion转发接口
		systemRouter.InitStableDiffusionImagesRouter(PublicGroup)   // stableDiffusion图片接口
		systemRouter.InitStableDiffusionSettingsRouter(PublicGroup) // stable-diffusion通用配置接口
